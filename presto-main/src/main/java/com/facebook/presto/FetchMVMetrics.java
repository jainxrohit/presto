...
//    String queryFile = "/Users/rohitism/work/mv/admetrics_queries/oct_06_12/test.csv";
//    String outputFile = "/Users/rohitism/work/mv/admetrics_queries/oct_06_12/testmetadata.txt";
//    String errorFile = "/Users/rohitism/work/mv/admetrics_queries/oct_06_12/test_error.txt";
    ...
    public static void main(String[] args)
            throws IOException
    {
        FetchMVMetrics fetchMVMetrics = new FetchMVMetrics();
        fetchMVMetrics.init();
    ...
    private void processFilterExpression(Expression expression)
    {
        ...
        if (expression instanceof Identifier) {
            ...
            expression.getChildren().stream().filter(c -> c instanceof Expression).forEach(e -> processFilterExpression((Expression) e));
        }
    }
}
