...
public class TestCreateMaterializedViewTask
{
    ...
    private static final String MV_A = "mv_a";
    private static final String MV_B = "mv_b";
    private static final String TBL_A = "tbl_b";
    ...
    public void testCreateMaterializedViewNotExistsTrue()
    {
        ...
        String sql = String.format("CREATE MATERIALIZED VIEW IF NOT EXISTS %s AS SELECT 2021 AS col_0 FROM %s", MV_A, TBL_A);
    ...
    {
        SqlParser parser = new SqlParser();
        String sql = String.format("CREATE MATERIALIZED VIEW %s AS SELECT 2021 AS col_0 FROM %s", MV_B, TBL_A);
        CreateMaterializedView statement = (CreateMaterializedView) parser.createStatement(sql, ParsingOptions.builder().build());
            ...
            extends AbstractMockMetadata
    {
        ...
        {
            if (tableName.getObjectName().equals(MV_A)) {
                return Optional.empty();
            }
            if (tableName.getObjectName().equals(TBL_A)) {
        ...
        public TableMetadata getTableMetadata(Session session, TableHandle tableHandle)
        {
            return new TableMetadata(
                    catalogHandle,
                    new ConnectorTableMetadata(new SchemaTableName(SCHEMA_NAME, TBL_A), emptyList()));
        }
